...
<body>
    ...
    <div style="margin: auto; width: 80%;">
        ...
        <p>
            ...
            The Ticketon service.kz is based on the software" X-Ticket", which is the company's own development and has a completely Kazakh origin. The ticket system is patented in Kazakhstan and is the root cash system for most of the objects connected to the service Ticketon.kz.
